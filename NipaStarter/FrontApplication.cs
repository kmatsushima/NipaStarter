...
namespace NipaStarter
{
	class FrontApplication
	{
		...
		public static void Startup(string appPath, int screenWidth, int screenHeight, string logDirectryPath = "")
		{
			...
			var logFileName = "UnityEngineLog_" + System.DateTime.Now.ToString("yyyyMMddHHmm") + ".txt";

			if (!System.IO.Directory.Exists(logDirectryPath))
			{
				Directory.CreateDirectory(logDirectryPath);
			}
